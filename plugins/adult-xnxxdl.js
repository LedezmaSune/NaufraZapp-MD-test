...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  ...
  if (!args[0]) throw `> ⚠️ *Por favor, ingrese un enlace valido xnxx, por ejemplo: ${usedPrefix + command} https://www.xnxx.com/video-14lcwbe8/rubia_novia_follada_en_cuarto_de_bano*`;
  try {
    await conn.reply(m.chat, '> ✅ *Se esta enviando el video, tardara dependiendo del peso.*', m);
    let xnxxLink = '';
