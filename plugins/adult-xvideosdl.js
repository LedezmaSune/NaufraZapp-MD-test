...
const handler = async (m, {conn, args, command, usedPrefix, text}) => {
  ...
  try {
    conn.reply(m.chat, '> ✅ *Se esta descargando el video, tardara dependiendo del peso.*', m);
   ...
   throw '> 📌 *Ocurrio un error, por favor, verifique que el enlace sea valido, por ejemplo::*\n*https://www.xvideos.com/video70389849/pequena_zorra_follada_duro*';
  }
};
