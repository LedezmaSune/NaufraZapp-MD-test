...
${user.bannedReason}` : '*Motivo:* Sin Especificar'}
        ...
        if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
          mconn.conn.reply(m.chat, `> ⓘ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝙙𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨, 𝙪𝙨𝙚 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤: *${usedPrefix}buyall*`, m);
          continue; 
        }
        if (plugin.level > _user.level) {
          mconn.conn.reply(m.chat, `> ⓘ 𝙇𝙤 𝙨𝙞𝙚𝙣𝙩𝙤, 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙚 𝙧𝙚𝙦𝙪𝙞𝙚𝙧𝙚 𝙚𝙡 𝙣𝙞𝙫𝙚𝙡: ${plugin.level} 𝙥𝙖𝙧𝙖 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤, 𝙩𝙪 𝙣𝙞𝙫𝙚𝙡 𝙚𝙨: ${_user.level}, 𝙥𝙪𝙚𝙙𝙚𝙨 𝙪𝙨𝙖𝙧 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤: ${usedPrefix}levelup 𝙥𝙖𝙧𝙖 𝙨𝙪𝙗𝙞𝙧 𝙙𝙚 𝙣𝙞𝙫𝙚𝙡.`, m);
          continue; 
        }
        const extra = {
          match,
        ...
        for (const user of participants) {
          ...
          /* ❒═════════════════◊【】◊═════════════════❒ */
            ...
            if (userPrefix && chat.antiArab && botTt.restrict && isBotAdminNn && action === 'add') {
              ...
              await m.conn.sendMessage(id, {text: `> ⓘ 𝙃𝙤𝙡𝙖 𝙪𝙨𝙪𝙖𝙧𝙞𝙤/𝙖: *@${user.split('@')[0]}, 𝙚𝙣 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤 𝙣𝙤 𝙨𝙚 𝙖𝙙𝙢𝙞𝙩𝙚𝙣 𝙣𝙪𝙢𝙚𝙧𝙤𝙨 𝙧𝙖𝙧𝙤𝙨, 𝙦𝙪𝙚 𝙣𝙤 𝙚𝙨𝙩𝙚𝙣 𝙚𝙣 𝙡𝙖 𝙗𝙖𝙨𝙚 𝙙𝙚 𝙙𝙖𝙩𝙤𝙨.`, mentions: [user]}, {quoted: fkontak2});
              return;
            }
...
let date = d.toLocaleDateString('es', { day: 'numeric', month: 'long', year: 'numeric' })
 let time = d.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true })
    try {
        ...
        /* ❒═════════════════◊【】◊═════════════════❒ */
                const antideleteMessage = `*Usuario* @${participant.split`@`[0]}
  *Enviando mensaje eliminado...*`.trim();
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '> ❮⚠️ \`ADVERTENCIA\` ⚠️❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙚𝙨 𝙨𝙤𝙡𝙤 𝙥𝙖𝙧𝙖 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙙𝙚𝙡 𝙗𝙤𝙩.',
    owner: '> ❮⚠️ \`ADVERTENCIA\` ⚠️❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙙𝙚𝙡 𝙗𝙤𝙩.',
    mods: '> ❮🔔 \`INFORMACION\` 🔔❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨 𝙙𝙚𝙡 𝙗𝙤𝙩.',
    premium: '> ❮🏆 \`INFORMACION\` 🏆❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙪𝙨𝙪𝙖𝙧𝙞𝙤𝙨 𝙥𝙧𝙚𝙢𝙞𝙪𝙢.',
    group: '> ❮🥏 \`INFORMACION\` 🥏❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙚𝙣 𝙜𝙧𝙪𝙥𝙤𝙨.',
    private: '> ❮👤 \`INFORMACION\` 👤❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙚𝙣 𝙘𝙝𝙖𝙩𝙨 𝙥𝙧𝙞𝙫𝙖𝙙𝙤𝙨.',
    admin: '> ❮👑 \`INFORMACION\` 👑❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤.',
    botAdmin: '> ❮🤖 \`INFORMACION\` 🤖❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙨𝙞 𝙚𝙡 𝙗𝙤𝙩 𝙚𝙨 𝙖𝙙𝙢𝙞𝙣.',
    unreg: '> ❮❕ \`INFORMACION\` ❕❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙚 𝙧𝙚𝙦𝙪𝙞𝙚𝙧𝙚 𝙪𝙣 𝙧𝙚𝙜𝙞𝙨𝙩𝙧𝙤 𝙥𝙖𝙧𝙖 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙧𝙡𝙤, 𝙪𝙨𝙚 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤:\n\n> #reg \`nombre.edad\`\n\n> #reg \`Naufrago.19\`',
    restrict: '> ❮⚠️ \`ADVERTENCIA\` ⚠️❯\n> •━━━━━━━━━━━━━━━━•\n> ⓘ 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙙𝙚𝙡 𝙗𝙤𝙩.',
    }[type];
